    ...
    <Box m="20px">
      ...
      <Box mb="30px">
        <h3
          ...
          // fontWeight="bold"
          // sx={{ m: "0 0 5px 0" }}
          className={` italic font-semibold  text-[${colors.grey[100]}] text-xl`}
        >
          Overview
        </h3>
      </Box>
      ...
      >
        ...
        <Box mb="30px">
          ...
          <div className="grid lg:grid-cols-[60%,40%] gap-5 w-full">
            <Transcale className=" pb-5 bg-white  rounded-[10px]  pt-2">
              <Box
                gridColumn="span 4"
                gridRow="span 2"
                backgroundColor={colors.primary[400]}
            ...
            <Transcale className=" pb-5 bg-white  rounded-[10px]  pt-2"></Transcale>{" "}
          </div>
        </Box>
